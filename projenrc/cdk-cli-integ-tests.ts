...
export interface CdkCliIntegTestsWorkflowProps {
  ...
  /**
   * Transfer everything in this directory form the build job
   */
  transferDirectoryFromBuild: string;
}
    ...
    runTestsWorkflow.addJob('build', {
      ...
      steps: [
        ...
        },
        {
          ...
          run: `cd ${props.transferDirectoryFromBuild} && getfacl -R . > permissions-backup.acl`,
        ...
        },
        {
          ...
          with: {
            name: 'build-artifact',
            path: props.transferDirectoryFromBuild,
            overwrite: 'true',
          }
        },
      ],
    ...
    runTestsWorkflow.addJob('integ', {
      ...
      steps: [
        ...
        },
        {
          ...
          run: `cd ${props.transferDirectoryFromBuild} && setfacl --restore=permissions-backup.acl`,
          continueOnError: true,
        },
        {
          name: 'Set up JDK 18',
        ...
        },
        {
          ...
          run: [
            ...
            `cat '${JSON.stringify(verdaccioConfig)}' > $HOME/.config/verdaccio/config.yaml`,
          ].join('\n'),
        },
        {
        ...
        },
        {
          ...
          run: `find ${props.transferDirectoryFromBuild} -name \\*.tgz -print0 | xargs -0 -n1 npm publish`,
        },
        {
